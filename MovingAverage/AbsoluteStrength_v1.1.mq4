...
#property indicator_color1    Blue //SmthBulls
#property indicator_width1    2 
#property indicator_color2    Red //SmthBears
#property indicator_width2    2
#property indicator_color3    RoyalBlue //SigBulls
#property indicator_width3    1
#property indicator_style3    2 
#property indicator_color4    Tomato //SigBears
...
//---- indicators
   ...
   SetIndexStyle(1,DRAW_LINE);//Red
   SetIndexBuffer(1,SmthBears);
   
   SetIndexStyle(2,DRAW_LINE);//RoyalBlue
   SetIndexBuffer(2,SigBulls);
   
   SetIndexStyle(3,DRAW_LINE);//Tomato
